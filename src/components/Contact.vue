...
<template>
  <section id="contact" class="sm:max-w-[475px] md:max-w-[640px] lg:max-w-[768px] xl:max-w-[1024px] 2xl:max-w-[1280px] mx-auto pt-24 mb-28 relative">
    <div>
      <div class="border border-myDark-100 py-2 px-6 w-fit rounded-full text-lg font-semibold mb-10">
        Contact
      </div>

      <p class="lg:w-[90%] font-primary md:text-4xl xl:text-5xl font-bold leading-[1.1] tracking-wide pb-20">
        Let's partner-up and witness the transformation of your website into a powerful asset for success.
      </p>
    </div>
