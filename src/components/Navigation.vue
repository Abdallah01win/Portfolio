...
<template>
  <section class="text-white">
    <nav
      class="sm:max-w-[475px] md:max-w-[640px] lg:max-w-[768px] xl:max-w-[1024px] 2xl:max-w-[1280px] mx-auto flex items-center justify-between py-5 border-b border-myGray-400/30">
