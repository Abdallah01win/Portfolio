    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-0">
        ...
        <div class="leading-8 text-base sm:text-lg font-medium">
          <p class="mb-8">
            I'm here to listen, understand your unique needs, and tailor a web
            solution that's as unique as your business. Expect open and
            transparent communication throughout our partnership, ensuring that
            your ideas are not just heard but also brilliantly executed.
          </p>
          <p>
