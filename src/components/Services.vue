...
<template>
  <section id="services"
    ...
    <div class="grid grid-cols-1 gap-x-8">
      <div class="text-lg">
        <div v-for="(service, index) in services" :key="service" class="border-b border-myGray-200/40 pb-5 md:pb-7"
          ...
          <div class="grid grid-cols-12 max-md:gap-x-0 gap-x-10">
            ...
            <div class="col-span-6 text-base leading-5 max-md:hidden">
              {{ service.description }}
            </div>
            <div
