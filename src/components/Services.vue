...
<template>
    <section id="services"
        class="sm:max-w-[475px] md:max-w-[640px] lg:max-w-[768px] xl:max-w-[1024px] 2xl:max-w-[1280px] mx-auto py-24">
        <div class="mb-10">
                ...
                <div v-for="service in services" :key="service" class="border-b border-myGray-500/40 py-7">
                    <div class="grid grid-cols-12">
                        <div class="col-span-6 flex items-center gap-x-10">
                            <div class="text-2xl font-primaryBold">{{ service.title }}</div>
                        </div>
