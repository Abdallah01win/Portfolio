    ...
    >
      <div class="py-16">
        <div class="flex items-center mb-12 md:mb-16">
          <div
            class="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-primaryBold"
          >
            Let's elevate your business!
          </div>
        </div>
        <div
          class="grid grid-cols-1 md:grid-cols-[1fr,0.7fr] gap-y-10 md:gap-y-0"
        >
          <div>
            <div class="flex items-center gap-x-6 mb-3">
              <RouterLink to="/" class="font-bold text-xl"
                >Abdallah<span class="text-myGray-500 italic">Bari</span>
              </RouterLink>
            </div>
            <p class="md:w-[70%] text-myGray-500 leading-7 mb-8">
              Feel free to reach-out to me on these platforms or follow me for
            ...
            <div class="flex items-center gap-x-6">
              <span class="hover:scale-[1.1] transition-all">
                <a
                  href="https://github.com/Abdallah01win"
                  target="_blank"
                  title="GitHub"
                >
              ...
              <span class="hover:scale-[1.1] transition-all">
                <a
                  href="https://twitter.com/AbdallahDev01"
                  target="_blank"
                  title="Twitter"
                >
              ...
              <span class="hover:scale-[1.1] transition-all">
                <a
                  href="https://www.linkedin.com/in/abdallahbari"
                  target="_blank"
                  title="LinkedIn"
                >
      ...
      <div
        class="text-sm md:text-base text-center py-8 tracking-wide text-myGray-500 border-t border-myGray-500/30"
      >
...
.mesh {
  background-image: url("@/assets/images/Texture.png"),
    radial-gradient(at 38% 145%, rgb(97, 34, 214) 0, hsla(240, 85%, 69%, 0) 50%),
    radial-gradient(
      at 130% 110%,
      rgb(59, 104, 230) 0,
      hsla(192, 91%, 57%, 0) 50%
